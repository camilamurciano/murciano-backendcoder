...
manager.addProduct("porta", "porta-agujas que sirve para suturar", 2500, "sin imagen", "IQ08", 12)
manager.addProduct("crille", "pinza hemostatica superficial", 1700, "sin imagen", "IQ09", 10)
manager.getProducts()

manager.addProduct("porta", "porta-agujas que sirve para suturar", 2500, "sin imagen", "IQ08", 12) // Repitiendo codigo para que no lo agregue
manager.addProduct("halsted", "pinza hemostatica superficial", 1600, "sin imagen", "IQ10", 10)
manager.getProducts()

manager.getProductsById(2) // Obteniendo productos mediante ID

manager.updateProduct(1, { title: "bertola", description:"pinza hemostatica para profundidad", price: 2000 }) // actualizando productos
